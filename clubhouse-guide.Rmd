...
By default, we leave breakers 7-14 -- the baseboard and north wall 240 V heaters -- **off**, and the remainder on. 
...
```{r, child='WSTJ-X-IC-7610.Rmd'}
```

```{r, child='WSTJ-X-K3S.Rmd'}
```
...
- Take the padlock to the gate with you.
