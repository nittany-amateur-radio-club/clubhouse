...
- Call CQ or answer a CQ
  ...
  - On the Flex 6400-M, use the Yaesu mic or headset with the footswitch for PTT.
...
- Confirm that version is __________ (last 7.0.9)
...
- Confirm latest version is ___________ (latest 1.0.10151)
...
- Open WSJT-X
- Confirm that version is __________ (last 2.5.4)
...
- Open JTAlert
- Confirm version is _________ (last 2.62.0)
...
- Open JS8Call
- Confirm version is __________ (last 2.2.0)
- Select W3YA configuration
...
- Open fldigi
- Confirm version is ____________ (last 4.1.26)
...
Confirm Winlink (not forms) version is _________ (latest 1.7.12)
...
Confirm VARA HF version is ___________ (latest 4.8.1)
...
Confirm verson is ____________ (latest 6.6.13)
...
Test amplification
Amp to operate (short press on OPER/STDBY)
Transmit (press TRANSMIT or PTT on mic) on rig 
~10 W drive should generate about 4-500 W out)
Press TRANSMIT again to end test transmission
Amplifier back to stand-by (short press on MODE/PF1)
...
- Open Win4Icom
- Confirm that version is _________ (last 1.4.5.4)
