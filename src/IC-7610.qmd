...
![Icom IC-7610](include/img/ic-7610.jpg)
...
![Antenna connections](include/img/antenna-connections.jpeg)
...
![IC-7610 power switch](include/img/ic-7610-power-switch.png)

6. Power up the Elecraft KPA1500 amplifier

The IC-7610/NARC1 is connected to the Elecraft [KPA1500](KPA1500.qmd) amplifier. 
...
![IC-7610 audio gain controls](include/img/ic-7610-af.png)
...
![IC-7610 band change controls](include/img/ic-7610-chg-band.png)


- Switch operating modes by pressing the mode button on the touch panel. 

![IC-7610 mode change control](include/img/ic-7610-chg-mode.png)
...
![IC-7610 bottom menu touch screen buttons](include/img/ic-7610-menu-touch-buttons.png)
...
![IC-7610 multifunction control](include/img/ic-7610-multi.png)
...
1. Open Amateur Contact Log (most recent version installed is 7.0.9)
