...
```{r, fig.cap="IC-7610"}
knitr::include_graphics("include/img/ic-7610.jpg")
```
...
knitr::include_graphics("include/img/astron-rs-35a.png")
```

5. Power up the IC-7610/NARC1 by pressing and briefly holding the power button.

```{r, fig.cap="IC-7610 power switch"}
knitr::include_graphics("include/img/ic-7610-power-switch.png")
```
...
knitr::include_graphics("include/img/kpa1500-power-switch.png")
```
