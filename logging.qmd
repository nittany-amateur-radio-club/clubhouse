...
![AC Log API Window](include/img/narc1-aclog-api-settings-.png){#fig-narc1-aclog-api-settings}
As @fig-narc1-aclog-api-settings indicates, click on **TCP API Enabled Server** checkbox and use the default port (1100).
